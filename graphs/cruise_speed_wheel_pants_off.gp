...
set label "75\\% Power" `./label_place.py data/cruise_speed_wheel_pants_off.txt 1 2000 40 14000` font "Times-Roman,20"
set label "65\\% Power" `./label_place.py data/cruise_speed_wheel_pants_off.txt 2 3500 40 14000` font "Times-Roman,20"
set label "55\\% Power" `./label_place.py data/cruise_speed_wheel_pants_off.txt 3 5000 40 14000` font "Times-Roman,20"
