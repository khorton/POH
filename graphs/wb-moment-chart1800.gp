...
set output '../graphs/wb-moment-chart1800.eps'
...
set arrow from 138,1945 to 151,1750 lw 4
...
plot 'data/wb-moment-chart1800.txt' with lines lt -1 lw 5 # lt -1 = blackline
