...
\begin{tabularx}{\textwidth}{|>{\setlength\hsize{.9\hsize}}Y|c|c|c|>{\setlength\hsize{1.1\hsize}}Y|}
  ...
  \hline
\ifthenelse{\thePMAG = 0}{Magneto&Slick&4371 rev C&98112422&\\}{Electronic Ignition&E-Mag&P-114L4&3338&VL 183611\\}
  \hline
...
\section{LIGHTING}
     \begin{tabularx}{\textwidth}{|>{\setlength\hsize{.9\hsize}}Y|c|c|c|>{\setlength\hsize{1.1\hsize}}Y|}
       ...
       \hline
       Tail Strobe + Nav Light Assembly&Whelan&02-0350034-01& - &A506M Flash Tube and Socket Assembly with Molex Connector\\
       \hline
       Tail Nav Light Bulb&Whelan&34-0412070-63& - &A508-14 Lamp, ERC Halogen (14 Volt)\\
       \hline
       Wing Nav Light Bulb&Whelan&34-0414020-65& - &A1290-14 Lamp\\
       &or Grimes&A-7512-12 or 7512-12& - &equivalent to A1290-14\\
       \hline
       \end{tabularx}
...
\begin{tabularx}{\textwidth}{|>{\setlength\hsize{.9\hsize}}Y|c|c|c|>{\setlength\hsize{1.1\hsize}}Y|}
       ...
       \hline
       Fuel Filter&Airflow Performance&AH-8504-02&&74 micron filter element\\
       \hline
       \end{tabularx}
