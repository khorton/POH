...
\begin{tabularx}{\textwidth}{|>{\setlength\hsize{.9\hsize}}Y|c|c|c|>{\setlength\hsize{1.1\hsize}}Y|}
  ...
  \hline
  Spark Plugs (Bottom)&Autolite&URHM38E&-&\\
  \hline
...
\begin{tabularx}{\textwidth}{|>{\setlength\hsize{.9\hsize}}Y|c|c|c|>{\setlength\hsize{1.1\hsize}}Y|}
  ...
  \hline
  Altimeter&Falcon Wultrad&ALT20INF-3N&ALT01110002&Made in China\\
  \hline
...
\section{AVIONICS}
  \begin{tabularx}{\textwidth}{|>{\setlength\hsize{.9\hsize}}Y|c|c|c|>{\setlength\hsize{1.1\hsize}}Y|}
    ...
    \hline
    ELT&ACK&E-04&001510&Hex ID: 27878 0CF7A FFBFF\\
    \hline
    Altitude Encoder&ACK&A-30&80388&\\
    \hline
    Intercom&PS Engineering&1194 0&BM-01352&PMA4000\\
    \hline
    Autopilot&Trio Avionics&Pro Pilot&PPR0316VL&\\
    \hline
