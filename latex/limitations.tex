...
\textcolor{red}{TBD}\\ \textcolor{red}{TBD}} & \multicolumn{1}{p{\colFour}|}{\centering~\\ 120\\
110}& Do not make full or abrupt control
movements above this speed. These speeds are estimates based on CAFE data\\
\hline
...
\begin{Note}[NOTE]
The analog airspeed indicator markings are based on position
...
\begin{Note}
  \textcolor{red}{The maximum passenger weight that is possible with the currently demonstrated aft CG of 85.3\char`\"{} aft of datum (aerobatic aft CG limit) is 250 lb (113.4 kg) unless ballast is carried in the forward baggage area.}
  \end{Note}
...
%\includegraphics*[viewport = 0 25 385 265]{../Diagrams/CG_envelope2.ps} % original chart from Grace
  \begin{center}
  \ifthenelse{\theMTOW > 1800}{\input{../graphs/cg_chart1900}}{\input{../graphs/cg_chart1800}}
  \end{center}  % chart from gnuplot
...
\begin{figure}[htb]
  \begin{center}
  \ifthenelse{\theMTOW > 1800}{\input{../graphs/g-chart1900}}{\input{../graphs/g-chart1800}}
  \end{center}  % chart from gnuplot
...
unless there are at least 10 USG of fuel remaining in the selected tank. 
This limitations mitigates potential disconnect of the flop tube in the left tank
from its connection at the front of tank.  This failure would significantly
increase the unusable fuel in the left tank.
...
\end{itemize*}\\
  ...
  \begin{tabular}{ccccc}
    ...
    \end{tabular}\\\\
  \raggedright Rear Seat& YOU FLY IN THIS AIRCRAFT AT YOUR OWN RISK. THIS AIRCRAFT DOES NOT COMPLY WITH INTERNATIONALLY RECOGNIZED STANDARDS. VOUS VOLEZ \`{A} BORD DE CET A\'{E}RONEF \`{A} VOS PROPRES RISQUES. CET A\'{E}RONEF NÕEST PAS CONFORME AUX NORMES RECONNUES \`{A} LÕ\'{E}CHELLE INTERNATIONALE.\\\\
