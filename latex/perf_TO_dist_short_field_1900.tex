...
% \addcontentsline{toc}{section}{Figure \ref{SFTO-Dist-1900} Short Field Takeoff Distance at 1900 lb}
\addcontentsline{toc}{section}{SHORT FIELD TAKEOFF DISTANCE --- 1900 lb}
\begin{center}
...
% \textcolor{red}{PREDICTED PERF TO BE CONFIRMED BY FLIGHT TEST}\vspace{5ex}\\
\normalsize 
