...
\begin{enumerate*}
  ...
  \begin{enumerate*}
	...
	\begin{enumerate*}
		...
		\item Fuel Pressure --- Check pressure from electric fuel pump is 25--45 psi.  \dotfill $\bigbox$
	...
	\begin{enumerate*}
  	...
  	\item Cylinder compression --- conduct compression check on all cylinders.  Record readings.  If compression test indicates problems, check internal condition and tolerances. \dotfill $\bigbox$
		\item Remove air filter and clean.  \dotfill $\bigbox$
		\item Check condition of alternate air door and cable. \dotfill $\bigbox$
		\item \textcolor{red}{Bendix FI items??}  \dotfill $\bigbox$
	...
	\begin{enumerate*}
		...
		\item Check pressure from electric fuel pump is 25--45 psi.  \dotfill $\bigbox$
  ...
  \end{enumerate*}
	...
	\begin{enumerate*}
		...
		\item Magneto drop --- check. \dotfill $\bigbox$
		\item Oil and fuel pressures --- check. \dotfill $\bigbox$
