...
\ifthenelse{\thePMAG = 1}{\section{SET PMAG ELECTRONIC IGNITION TIMING}
\begin{enumerate*}
	\item Set the engine to TDC for cylinders 1 and 2.
	\item Select PMag OFF and PMag BU Pwr to ON. LED on PMag should be illuminated steady Red. 
	...
	\item Move prop around TDC. LED should be Red prior to TDC, and Green at TDC.
	\item Select PMag to OFF.
	\end{enumerate*}
